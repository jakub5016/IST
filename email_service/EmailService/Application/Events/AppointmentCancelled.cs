...
namespace EmailService.Application.Events
{
    public class AppointmentCancelled
    {
        ...
        public AppointmentCancelled(Guid appointmentId, Guid patientId, string appointmentType, string username, string patientEmail, string doctorEmail, float price, DateTime startTime, DateTime endTime)
        {
